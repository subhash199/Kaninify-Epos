        ...
        public async Task InitializePrinterAsync()
        {
            try
            {
                ...
                if (currentSite?.Site_Id != null)
                {
                    ...
                    var primaryPrinter = await GetPrimaryPrinterForSiteAsync(currentSite.Site_Id);
                    ...
                    var sitePrinter = await GetActivePrinterForSiteAsync(currentSite.Site_Id);
                    if (sitePrinter != null)
                    {
